...
const {
  getVozmojnostiData,
  postVozmojnostiData,
} = require("../controllers/vozmojnostiDataController");

router.route("/vozmojnosti").get(getVozmojnostiData).post(postVozmojnostiData);

// Registraciya роутер
const {
  getRegistraciyaData,
  postRegistraciyaData,
} = require("../controllers/registraciyaDataController");

router.route("/registraciya").get(getRegistraciyaData).post(postRegistraciyaData);
